...
class InternetSpeedTestApp:
    def __init__(self, root):
        ...
        self.test_button = tk.Button(root, text="Comienzo del test", command=self.start_test)
    ...
    def run_speedtest(self):
        try:
            ...
            location = results["server"].get("location", "Desconocido")  # Manejar la ausencia de 'location'
